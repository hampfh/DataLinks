...
import { loginRedirect, registerUserIfAbsentInDb, updateLoginStats } from "../middlewares/auth"
...
router.get("/login", oidc.login, registerUserIfAbsentInDb, updateLoginStats, loginRedirect)
